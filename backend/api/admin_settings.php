...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $payload = [
        ...
        'rewards_hero_banner_url' => trim((string)($data['rewards_hero_banner_url'] ?? '')),
        'rewards_hero_banner_link_url' => trim((string)($data['rewards_hero_banner_link_url'] ?? '')),
        'rewards_hero_banner_pure_mode' => !empty($data['rewards_hero_banner_pure_mode']) ? 1 : 0,
        'rewards_hero_banner_mobile_url' => trim((string)($data['rewards_hero_banner_mobile_url'] ?? '')),
        'rewards_hero_banner_height_desktop' => max(120, min(520, (int)($data['rewards_hero_banner_height_desktop'] ?? ($defaults['rewards_hero_banner_height_desktop'] ?? 220)))),
        'rewards_hero_banner_height_mobile' => max(96, min(360, (int)($data['rewards_hero_banner_height_mobile'] ?? ($defaults['rewards_hero_banner_height_mobile'] ?? 168)))),
        'top_strip_banner_url' => trim((string)($data['top_strip_banner_url'] ?? '')),
        'top_strip_banner_link_url' => trim((string)($data['top_strip_banner_link_url'] ?? '')),
        'top_strip_banner_mobile_url' => trim((string)($data['top_strip_banner_mobile_url'] ?? '')),
        ...
        'home_reward_slider_limit' => max(1, min(12, (int)($data['home_reward_slider_limit'] ?? ($defaults['home_reward_slider_limit'] ?? 3)))),
        'welcome_popup_image_url' => trim((string)($data['welcome_popup_image_url'] ?? '')),
        'welcome_popup_button_label' => trim((string)($data['welcome_popup_button_label'] ?? ($defaults['welcome_popup_button_label'] ?? 'شروع پیشبینی'))) ?: ($defaults['welcome_popup_button_label'] ?? 'شروع پیشبینی'),
        'welcome_popup_button_url' => trim((string)($data['welcome_popup_button_url'] ?? ($defaults['welcome_popup_button_url'] ?? '/'))) ?: ($defaults['welcome_popup_button_url'] ?? '/'),
